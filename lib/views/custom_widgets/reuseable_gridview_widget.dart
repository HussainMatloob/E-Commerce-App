    ...
    return Container(
      ...
      child: Column(
        children: [
            ...
            child: Container(
              ...
              child: ClipRRect(
                ...
                child: CachedNetworkImage(
                  ...
                  width: mq.width * 0.5,
                  imageUrl: widget.details.image![0].toString(),
                  fit: BoxFit.fill,
          ...
          Center(
            child: Text(
              widget.details.productName.toString(),
              overflow: TextOverflow.ellipsis,
              style: TextStyle(fontSize: 10),
              textAlign: TextAlign.center,
            ),
          ),
          widget.details.sale == "Sale"
              ? Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Center(
                      child: Text(
                        "Rs:" + widget.details.salePrice.toString(),
                        style: TextStyle(fontSize: 10),
                        textAlign: TextAlign.center,
                      ),
                    ),
              ...
              : Center(
                  child: Text(
                    "Rs:" + widget.details.price.toString(),
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(fontSize: 10),
                    textAlign: TextAlign.center,
                  ),
