                    ...
                    if (data != null && data.isNotEmpty) {
                      ...
                      return Center(
                        child: badges.Badge(
                          ...
                          badgeContent: Text(newData['Counter'].toString(),
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child: Text(
                                                      list[index].productName,overflow: TextOverflow.ellipsis,
                                                  style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.bold),
                                                ),
                                      ...
                                      children: [
                                        InkWell(
                                          onTap: () {
                                            ...
                                            ServicesOrApis.lessTotalAndCount(
                                                list[index]);
                                          },
                                          child: Container(
                            ...
                            return Container(
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    "Total: Rs." + newData['Total'].toString(),
                                    style: TextStyle(
                                      fontSize: 14,
                                      fontWeight: FontWeight.bold,
                                      color: Colors.white,
