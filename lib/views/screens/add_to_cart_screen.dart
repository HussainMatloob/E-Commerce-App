...
import 'package:e_commerce_app/views/screens/payment_method_screen.dart';
import 'package:e_commerce_app/views/screens/photo_view_screen.dart';
                  ...
                  child: Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: CachedNetworkImage(
                        ...
                        imageUrl: widget.productDetails.image![0].toString(),
                        fit: BoxFit.fill,
                ...
                Container(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          widget.productDetails.sale == 'Sale'
                              ? Row(
                                  children: [
                                    SizedBox(
                                      width: mq.width * 0.02,
                      ...
                      onTap: () async {
                        if (ServicesOrApis.user != null) {
                          EasyLoading.instance
                            ..loadingStyle =
                                EasyLoadingStyle.custom // Set the custom style
                            ..textColor =
                                Colors.white // Color of the loading status text
                            ..indicatorColor =
                                Colors.white // Color of the loading indicator
                            ..progressColor = Colors
                                .white // Progress color of the loading indicator (if applicable)
                            ..backgroundColor = Colors
                                .green // Background color of the loading indicator
                            ..maskColor = Colors
                                .red; // Mask color of the loading (if applicable)
                          ...
                          ServicesOrApis.addProductToCart(widget.productDetails)
                            ...
                            if (value == true) {
                              ...
                              ServicesOrApis.addTotalAndCount(
