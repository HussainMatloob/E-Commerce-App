        ...
        child: Form(
          ...
          child: ListView(
            children: [
                      ...
                      child: SizedBox(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: InkWell(
                                onTap: () {
                                  controller.ObsecureSignup(
                                      controller.obsecurePasswordSignup);
                                },
                                child: controller.obsecurePasswordSignup
              ...
              GetBuilder<Util>(builder: (controller) {
                return Align(
                  child: GestureDetector(
                    onTap: () {
                      if (logKey.currentState!.validate()) {
                        controller
                            .loadingFunctionSignup(controller.loadingSignup);
                        _auth
                          ...
                          final NotificationService deviceTokenController =
                              Get.put(NotificationService());
                          sp.setString('deviceToken',
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(10)),
                      child: Center(
                        child: controller.loadingSignup
