...
import '../../main.dart';
import '../../views/custom_widgets/home_bottom_bar.dart';
                      ...
                      child: SizedBox(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: InkWell(
                                onTap: () {
                                  controller.ObsecureLogin(
                                      controller.obsecurePasswordLogin);
                                },
                                child: controller.obsecurePasswordLogin
                  ...
                  child: GestureDetector(
                    onTap: () {
                      if (logKey.currentState!.validate()) {
                        controller
                            .loadingFunctionLogin(controller.loadingLogin);
                        _auth
