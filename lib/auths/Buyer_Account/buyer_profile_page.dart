                    ...
                    ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          if (image != null) {
                            ...
                            await ServicesOrApis.updateProfilePicture(File(image.path));
              ...
              itemBuilder: (context) => [
                PopupMenuItem(
                  ...
                  child: InkWell(
                    ...
                    child: ListTile(
                      title: Text("Set Location",style: TextStyle(fontWeight: FontWeight.bold),),
                ...
                PopupMenuItem(
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>HomeBottomBar()));
